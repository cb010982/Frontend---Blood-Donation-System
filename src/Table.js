    ...
    <div>
      <div className="tablecover">
        ...
        {(tableName === TableNames.DONORSEARCH) && (
          ...
          <div>
            <Dropdown dropdown='districtdropdown' className="dropdown2"/>
...
function generateRows(tableName) {
  ...
  if (tableName === TableNames.DONORHISTORY) {
    ...
    const numberofRows = 2;
    const NIC = [""];
    const locationInput = <input type="text" className="location" />;
    const amountInput = <input type="number" min="0" className="inputnum" />;
    const reward = <input type="number" min="0" className="inputnum"  />;
